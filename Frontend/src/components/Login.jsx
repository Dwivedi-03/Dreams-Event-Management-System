...
function Login() {
  ...
  return (
    <>
      ...
      <main className="h-screen flex justify-center items-center bg-no-repeat bg-center bg-cover bg-[url('https://images.pexels.com/photos/2306281/pexels-photo-2306281.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')]">
